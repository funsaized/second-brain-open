...
* Remaining P2/R8 gate: owner judgment of the synthetic content interpretation; native interruption/recovery, edit-authorized injection and remaining model-level missing-resource refusal cases. Launch guards/fake-provider errors do not establish every semantic refusal. Synthetic privacy preparation, runs and bounded operator-validated edits are authorized; personal sources remain out of scope. Real-source/provider policy, private backup/restore, R7B private reporting and P3 installation remain gated. Namespace fixtures are ephemeral; ordinary live OpenCode sessions retain their normal local history.
